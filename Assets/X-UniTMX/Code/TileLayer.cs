						...
						y += directionY)
					{
						...
						if (t != null && t.TileSet.Equals(tileSet))
						{
							...
							uv.AddRange(new Vector2[] {
								new Vector2((t.Source.xMin + 0.001f) / (float)tileSet.Texture.width, (t.Source.yMin + 0.001f) / (float)tileSet.Texture.height),
								new Vector2((t.Source.xMin + 0.001f) / (float)tileSet.Texture.width, (t.Source.yMax - 0.001f) / (float)tileSet.Texture.height),
								new Vector2((t.Source.xMax - 0.001f) / (float)tileSet.Texture.width, (t.Source.yMin + 0.001f) / (float)tileSet.Texture.height),
								new Vector2((t.Source.xMax - 0.001f) / (float)tileSet.Texture.width, (t.Source.yMax - 0.001f) / (float)tileSet.Texture.height)
							});
